export const needs = {
  ...
  water: {
    ...
    explanation:
      'Proportion of households without access to improved sources of drinking water',
    unit:
      '% of households have no access to improved sources of drinking water',
    kpi: '25.6%',
    min: 0,
  ...
  shelter: {
    ...
    min: 0,
    indicators: [
      'shelter_informal_settlers_nhts',
      'shelter_electricity',
      'shelter_makeshift_nhts'
    ],
  ...
  education: {
    ...
    explanation:
      'Proportion of children 6-16 years old who are not attending school',
  ...
  participation: {
    ...
    min: 84,
    indicators: [
      'participation_assembly_attendance',
      'participation_turnout',
      'participation_coop'
    ],
...
export const indicators = {
  ...
  protect: {
    ...
    paint: {
      'fill-color': [
        'case',
        ['==', ['get', 'SocialProtection_Prop'], null],
        '#ededed',
        ['!=', ['get', 'SocialProtection_Prop'], null],
        '#f7903d',
        '#ededed'
