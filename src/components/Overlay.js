    ...
    return (
      <div className={this.props.className}>
        <div className='information'>
          ...
          <p className='need-text'>{needs[this.props.need].titles}</p>
          <svg
            width='100%'
            height='10'
            version='1.1'
          ...
          >
            <text text-anchor='start' x='0%' y='10' className='need-body'>
              0%
            </text>
            <text text-anchor='end' x='100%' y='10' className='need-body'>
              100%
            </text>
          </svg>
          <svg
          ...
          >
            ...
            <rect
              ...
              width='100%'
              height='10'
              fill='url(#legendColor)'
            />
          </svg>
          <p className='need-body'>{needs[this.props.need].explanation}</p>
          <div className='horiz-dotted' />
          <p className='kpi'>{needs[this.props.need].kpi}</p>
          <div className='chart'>
            <ResponsiveOrdinalFrame
              ...
              oAccessor={'Pro_Code'}
              rAccessor={d =>
                d.score - (d.score > 0 ? needs[this.props.need].min : 0)
              }
              ...
              tooltipContent={d => (
                <div className='tooltip-content'>
                  <p>
                    {d.Pro_Name}: {Math.round(d.score * 100) / 100}
                    {needs[this.props.need].unit}
                  </p>
                </div>
              )}
            />
